 ...
 */
public class ValidRelativePathValidator extends AbstractFieldValidatorWithDefaultValueQuickFix {

  public ValidRelativePathValidator(JTextField field, JBLabel label, String defaultValue, FacetValidatorsManager manager) {
  ...
  public String getErrorMessage(JTextField field, JBLabel label) {
    ...
    if (SwingUtils.isVisible(field) && StringUtils.isNotBlank(text) && !ValidationUtils.isValidRelativePath(text)) {
